...
# video_path = '/Users/sarthakjain/Desktop/video3.mp4'
...
# print("Unique Number Plates:", unique_number_plates)
...
for j in pre_final_numberplates:
    if j[2].isdigit() and j[3].isdigit():
        final_numberplates.append(j)

print(final_numberplates)
print("Code exited succesfully!")
'''
